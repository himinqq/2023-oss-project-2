...
def split_dataset(dataset_df):
    x = dataset_df.drop(columns="salary", axis=1)  # feature
    y = dataset_df["salary"] * 0.001  # target(label): 모델이 예측하고자 하는 목표 변수
...
def extract_numerical_cols(dataset_df):
    ...
    numerical_extract = dataset_df[numerical_cols]
    return numerical_extract
